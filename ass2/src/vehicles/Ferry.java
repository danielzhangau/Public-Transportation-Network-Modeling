...
public class Ferry extends PublicTransport {
     ...
     * but with an additional component at the end, namely the ferry type. The encoded format should be as follows:
     *
     * <p>'{type},{id},{capacity},{route},{ferryType}'
     *
     * <p>where {ferryType} is replaced by the type of this ferry,
     * and all of the other components are the same as defined in the method being overridden. For example:
     *
