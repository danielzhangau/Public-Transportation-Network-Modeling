...
public class Train extends PublicTransport {
     ...
     * but with an additional component at the end, namely the carriage count. The encoded format should be as follows:
     *
     * <p>'{type},{id},{capacity},{route},{carriages}'
     *
     * <p>where {carriages} is replaced by the carriage count of this train, and all of the other components are the same as defined in the method being overridden. For example:
     *
     * <p>train,3,100,3,5
     *
     * Specified by:
